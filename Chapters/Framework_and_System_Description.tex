...
\subsubsection*{Setup and Registration Algorithms}
...
\begin{enumerate}
	...
	\item Decryption - The user does an exponentiation on the partially decrypted ciphertext to get the blinding element (BE) for decryption.
...
The CSP could be any of the providers such as the AWS cloud, Google cloud to name a few while the CA could be provincial or federal authorities responsible for oversight and regulations related to health care and privacy.
...
\begin{table}[]
	...
	\begin{tabular}{|c|p{0.75\linewidth}|}
		...
		\textbf{Response}    & Transform algorithm is run and if the provided information is valid, a partially decrypted ciphertext is returned to the user.             \\ \hline
	\end{tabular}
