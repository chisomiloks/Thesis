...
\begin{figure}[]
	\centering
	\includegraphics[width=\textwidth]{"Use Case Diagram (Initialization and Registration Scenario)"}
...
\begin{figure}[]
\centering
\includegraphics[width=\textwidth]{"Use Case Diagram (Data Flow Scenario)"}
...
\begin{figure}[]
	\centering
	\includegraphics[width=\textwidth]{"Use Case Diagram {Revocation}"}
