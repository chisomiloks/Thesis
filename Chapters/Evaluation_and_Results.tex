...
\begin{figure}[]
	\centering
	\includegraphics[width=\textwidth]{"Scheme Performance (Encryption_AAs)"}
...
\begin{figure}[]
	\centering
	\includegraphics[width=\textwidth]{"Scheme Performance (Decryption_AAs)"}
...
\begin{figure}[]
	\centering
	\includegraphics[width=\textwidth]{"Scheme Performance (Revocation_AAs)"}
